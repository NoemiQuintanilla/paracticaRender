...
# IMPORTAR para base de datos postgrest
...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'cineutc-s3qu.onrender.com').split(',')
...
# CONFIGURACION DE LA CARPETA PARA SUBIR ARCHIVOS ESTATICO 
STATIC_URL = '/static/'
